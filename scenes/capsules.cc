...
Capsules::Capsules() {
  setName("Capsules");
  SDF* s1 = new Sphere(vec3(0, 0, 0), 1.5, Material(colors::RED, 0.1, 1.0, 0.5, 0, 1.0, 300));
  SDF* s2 = new Sphere(vec3(0, 0, 0), 1.5, Material(colors::YELLOW, 0.1, 1.0, 0.5, 0, 1.0, 300));
  SDF* s3 = new Sphere(vec3(0, 0, 0), 1.5, Material(colors::GREEN, 0.1, 1.0, 0.5, 0, 1.0, 300));
  SDF* s4 = new Sphere(vec3(0, 0, 0), 1.5, Material(colors::BLUE, 0.1, 1.0, 0.5, 0, 1.0, 300));
