...
void createStars1Scene(Scene *res) {
  ...
  res->modifiable_rendering_params().camera_settings.eye_pos = vec3(0, 30, -30);
  res->modifiable_rendering_params().camera_settings.target = sun_center;
}
